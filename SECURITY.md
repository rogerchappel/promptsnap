...
Replace this section with the supported versions for `promptsnap`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `promptsnap` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in promptsnap.
